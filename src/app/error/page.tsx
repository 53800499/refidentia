...
import { ERROR } from "@/constants/wording";

export const metadata: Metadata = {
  title: "Erreur - Portefeuille Central",
  description: "Une erreur est survenue. Retournez à l'accueil ou contactez notre support.",
  // other metadata
};
