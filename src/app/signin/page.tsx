        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="shadow-three dark:bg-dark mx-auto max-w-[500px] rounded-sm bg-white px-6 py-10 sm:p-[60px]">
              ...
              <button className="border-gray-200 text-body-color hover:border-blue-500 hover:bg-blue-500/5 hover:text-blue-500 mb-6 flex w-full items-center justify-center rounded-lg border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden transition-all duration-300">
                <span className="mr-3">
                  <svg
                    width="20"
                    height="20"
              ...
              <button className="border-gray-200 text-body-color hover:border-blue-500 hover:bg-blue-500/5 hover:text-blue-500 mb-6 flex w-full items-center justify-center rounded-lg border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden transition-all duration-300">
                ...
                {SIGNIN.GITHUB_SIGNIN}
              </button>
              <div className="mb-8 flex items-center justify-center">
                <span className="bg-body-color/50 hidden h-[2px] w-full max-w-[400px] sm:block"></span>
              ...
              <form>
                <div className="mb-8">
                  ...
                  <Input
                    ...
                    className="mb-4 w-full rounded-lg border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden h-11 w-full bg-gray-100 pr-15 text-gray-800 placeholder:text-gray-500 sm:h-12"
                  />
                </div>
                <div className="mb-8">
                  <label
                  ...
                  <Input
                    ...
                    className="mb-4 w-full rounded-lg border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden h-11 w-full bg-gray-100 pr-15 text-gray-800 placeholder:text-gray-500 sm:h-12y"
                  />
                </div>
                ...
                <div className="mb-6">
                  <Button
                    asChild
                    className="h-12 w-full justify-center gap-2.5 py-1.5 px-6 text-base tracking-base">
                    <Link href="#">{SIGNIN.SIGNIN_BUTTON}</Link>
                  </Button>
                </div>
              </form>
